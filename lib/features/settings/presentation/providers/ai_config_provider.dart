...
import '../../../../core/services/local_speech_service.dart';

/// Provider for Local Speech Service (Native STT - not ML Kit)
final localSpeechServiceProvider = Provider<LocalSpeechService>((ref) {
